<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="tutordetails.aspx.cs" Inherits="tutordetails" %>
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="aboutus_area wow fadeInLeft">
            ...
            <p>Online tutoring is the process of tutoring in an online, virtual environment or networked environment in which teachers and learners are separated by time and space. Online tutoring, as a reflection of the diversity of the wider Internet, is practiced using many different approaches and is addressed to distinct sets of users. The distinctions are in online content and interface, as well as in tutoring and tutor-training methodologies. Definitions associated with online tutoring vary widely, reflecting the ongoing evolution of the technology, the refinement and variation in online learning methodology, and the interactions of the organizations that deliver online tutoring services with the institutions, individuals, and learners that employ the services. This form of Internet service is a classical micropublishing situation.</p>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
              ...
              <ul class="course_nav">
                <li>
                  <div class="single_course">
                    ...
                    <h3 class="singCourse_title"><a href="#">Introduction To Magento</a></h3>
                ...
                <li>
                  <div class="single_course">
                    ...
                    <div class="singCourse_content">
                    <h3 class="singCourse_title"><a href="#">Introduction To Wordpress</a></h3>
                    <p class="singCourse_price"><span>$20</span> Per One Month</p>
                    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
                    </div>
                    <div class="singCourse_author">
